...
- Younger customer churn appears strongly linked to tenure.
...
- Customers with multiple complaints were significantly more likely to leave the bank.
...
- Multi-product customers showed stronger retention.
...
- [Executive Summary Deck](slides/Customer_Churn_Analysis.pdf)
